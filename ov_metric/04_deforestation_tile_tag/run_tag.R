...
if (!dir.exists(file.path(project_root, "build")) || !dir.exists(file.path(project_root, "analysis"))) {
  stop("Deforestation tag build/analysis directories not found under: ", project_root, call. = FALSE)
}
