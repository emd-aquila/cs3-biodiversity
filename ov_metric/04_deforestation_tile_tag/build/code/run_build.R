# =====================================================
# Run all code in the "build" subdir of 04_deforestation_tile_tag
# =====================================================
...
# -----------------------
# Loop over database x cluster method x radius runs
# -----------------------

for (i in seq_len(nrow(cluster_run_grid))) {
  cluster_database_i <- cluster_run_grid$cluster_database[i]
