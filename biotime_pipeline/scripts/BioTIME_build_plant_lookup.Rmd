...
# Load GBIF backbone taxonomy (only need to do once per backbone version)
```{r}
# Assign and load backbone data
gbif_file <- "../data/Taxon.tsv"  # backbone data from GBIF circa June 2025
...
```{r}
write_csv(plant_lookup_slim, "../data/plant_code_lookup.csv")
cat("Plant code lookup table written to ../data/plant_code_lookup.csv\n")
```