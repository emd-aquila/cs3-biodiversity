...
path_radii <- vapply(clustered_paths, parse_radius_km, numeric(1))
path_methods <- vapply(clustered_paths, parse_method, character(1))
base_path <- clustered_paths[
  !is.na(path_radii) &
    path_radii %in% target_radii &
    path_methods %in% target_methods
][[1]]
