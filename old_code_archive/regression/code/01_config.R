...
# Regress completed tagged radii only. Add 5 and 7.5 km after their clustering
# and tagging outputs have finished.
cluster_radii <- c(2.5, 10)
pending_cluster_radii <- c(5, 7.5)
