...
if (!exists("cluster_raw")) {
  stop("cluster_raw is not defined. Run 05_load_cluster_data.R first.")
}

if (!exists("analysis_crs")) {
...
message("  current cluster file: ", basename(cluster_file_path))
